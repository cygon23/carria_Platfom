                ...
                <form action="login.php"  method="POST" >
                    ...
                    <div class="">
                        <div class="d-flex justify-content-between gap-2">
                            ...
                            <a href="forgot-password" style="color:#fe047f;" class="fw-medium">Forgot Password?</a>
                        </div>
                    </div>

                    <button name="login" type="submit" style="background-color:#fe047f; border: white solid 1px;" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Sign In</button>
                    ...
                    <div class="mt-32 text-center text-sm">
                        <p class="mb-0">Don’t have an account? <a href="sign-up.php" style="color:#fe047f;" class="fw-semibold">Sign Up</a></p>
                    </div>

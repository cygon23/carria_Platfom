...
<body data-instant-intensity="mousedown">
    ...
    <!-- Vendor JS Files -->
    <script src="{{ url('test/assets/vendor/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ url('test/assets/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ url('test/assets/vendor/chart.js/chart.umd.js') }}"></script>
    <script src="{{ url('test/assets/vendor/echarts/echarts.min.js') }}"></script>
    <script src="{{ url('test/assets/vendor/quill/quill.js') }}"></script>
    <script src="{{ url('test/assets/vendor/simple-datatables/simple-datatables.js') }}"></script>
    <script src="{{ url('test/assets/vendor/tinymce/tinymce.min.js') }}"></script>
    <script src="{{ url('test/assets/vendor/php-email-form/validate.js') }}"></script>

    <!-- Template Main JS File -->
    <script src="{{ url('test/assets/js/main.js') }}"></script>

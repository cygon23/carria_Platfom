    ...
    <section class="section-1 py-5 ">
        <div class="container">
            <div class="card border-0 shadow p-5">
                <form action="{{ route('/account/jobs') }}">
                    <div class="row">
                    ...
                    @foreach ($categories as $category)
                        <div class="col-lg-4 col-xl-3 col-md-6">
                            <div class="single_catagory">
                                <a href="{{ route('/account/jobs') . '?category=' . $category->id }}">
                                    <h4 class="pb-2">{{ $category->name }}</h4>
                                </a>
                                {{-- @foreach ($categories as $category)
                                    <p class="mb-0">
                                        <span>{{ $category->jobs_count }}</span> Available
                                        position{{ $category->jobs_count == 1 ? '' : 's' }}
                                    </p>
                                @endforeach --}}
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                {!! Str::words($featuredJob->description, 10, '...') !!}
                                                ...
                                                <div class="d-grid mt-3">
                                                    <a href="{{ route('/account/jobs/detail', $featuredJob->id) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="card border-0 p-3 shadow mb-4">
                                            <div class="card-body">
                                                ...
                                                {{-- <p>
                                                    {{ Str::words(strip_tags($latestJob->description), 10) }}
                                                    <a href="{{ route('/account/jobs/detail', $latestJob->id) }}"

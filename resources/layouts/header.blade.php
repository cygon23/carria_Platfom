                        ...
                        <div class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                            ...
                            <a href="javascript:void(0)" class="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between">
                                <div class="text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="text-md fw-semibold mb-4">Rahaman</h6>
        ...
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="javascript:void(0)"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Create CV</a>
                    </li>
                    <li>
                        <a href="./cv/invoice-preview.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Preview</a>
                    </li>
                    <li>
                        <a href="./cv/invoice-add.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i>Download CV</a>
                    </li>
                    <li>
                        <a href="./cv/invoice-edit.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i> Edit</a>
                    </li>
                </ul>
            </li>
            <li>
